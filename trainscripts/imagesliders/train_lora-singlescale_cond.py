...
#                 1, 25, (1,)
            ...
            img1 = Image.open(f'{folder_main}/{folder1}/{ims[random_sampler]}').resize((image_size,image_size))
            img2 = Image.open(f'{folder_main}/{folder2}/{ims[random_sampler]}').resize((image_size,image_size))
